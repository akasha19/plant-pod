...
export class PlantpediaPageComponent implements OnInit {
    ...
    this.plants = [
      {
        ...
        minhumidity: 50,
        maxhumidity: 100,
        imgsrc: "assets/img/bananaplant.jpg"
      },
      {
        id: 2,
      ...
      },
      {
        ...
        minhumidity: 10,
        maxhumidity: 70,
        imgsrc: "assets/img/aloevera.jpg"
      },
      {
        id: 4,
        ...
        minhumidity: 50,
        maxhumidity: 100,
        imgsrc: "assets/img/luckybamboo.jpg"
      },
      {
        id: 5,
        ...
        minhumidity: 50,
        maxhumidity: 75,
        imgsrc: "assets/img/pancakeplant.jpg"
      }
    ]
  ...
  maxtempWarn = "(Maximum Temperature) Too high temperatures for this plant could dry out, and kill the plant. Try opening a window or turning down the heating. If the plant is in direct sunlight, try moving it to a less sunny area for some time.";
  mintempWarn = "(Minimum Temperature) When the plant is too cold, it could damage the plant and eventually kill it. Too cold environments for the plant will also stop it from growing. Try putting the plant in a more sunny area, turning up the heat for some time, or closing a window.";
  maxphWarn = "(Maximum pH) Different plants require different soil acidity (pH) to grow healthily. A pH that is too high for the plant, could eventually kill the plant. Try adding a small amount of aluminium sulfate or elemental sulfur in order to lower the pH.";
  minphWarn = "(Minimum pH) Different plants require different soil acidity (pH) to grow healthily. A pH that is too low for the plant, could eventually kill the plant. Adding granulated limestone to the soil will help increase the pH of the soil."
